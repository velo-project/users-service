package com.github.veloproject.infrastructure.tables;
...
public class UserTable {
    ...
    private Set<RoleTable> roles;

    public UserTable(String name, String nickname, String email, String password) {
        this.name = name;
