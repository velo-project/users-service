        ...
        <html lang="pt-BR">
          ...
          <body>
            <div class="container">
              ...
              <p>
                <strong>Olá! 👋</strong><br />Vimos que você está tentando acessar o
                Velo. Aqui está seu código de <strong>autenticação de dois fatores 🔒</strong>:
              </p>
              ...
              <div class="footer">
                ...
                <strong><u>houve uma tentativa de login</u></strong
                >. Caso você <strong><u>não reconheça este acesso</u></strong>, <strong><u>altere sua senha</u></strong> e
                entre em contato conosco pela nossa <strong><u>Central de Ajuda</u></strong>.
              </div>
            </div>
          </body>
        </html>
